...
def track_random_walk(time_steps, p):
    actual_track = []
...
if __name__ == "__main__":
    ...
    sen1 = track_random_walk(time, [0.25, 0.25, 0.40, 0.10]).reshape(time, 2, 1)
    sen2 = track_random_walk(time, [0.25, 0.25, 0.40, 0.10]).reshape(time, 2, 1)
    sen3 = track_random_walk(time, [0.25, 0.25, 0.40, 0.10]).reshape(time, 2, 1)
