...
if __name__ == "__main__":
    ...
    color = ['rgba(0, 0, 255, 1)', 'rgba(0, 255, 0, 0.3)', 'rgba(255, 0, 0, 0.3)', 'rgba(0, 0, 0, 0.3)',
    ...
    fig.add_trace(go.Scatter(x=[i[0] for i in sensors], y=[i[1] for i in sensors], mode="lines",
                             marker={'size': 9, 'color': 'rgba(255, 0, 255, 1)'}))
